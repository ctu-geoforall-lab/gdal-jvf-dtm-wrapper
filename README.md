...
ogrinfo \
 ...
 -oo XSD=gdal_jvf_dtm_wrapper/xsd/v150/index/index_data.xsd \
 -oo CONFIG_FILE=gdal_jvf_dtm_wrapper/gmlasconf.xml \
 GMLAS:tests/sample_data/v150/ukazka_DI.jvf.xml
```

Test GDAL JVF DTM wrapperu:

```
python3 -m pytest tests/test_wrapper.py --jvf_version 1.5.0.beta4
```
